...
export default class Chart {
    _width: number;
    _height: number;
    _margins: { top: number; left: number; right: number; bottom: number; };
    _data: never[];
    _scaleX: any;
    _scaleY: any;
    _colors: any;
    ...
    _svg: any;
    _body: any;
    _padding: { top: number; left: number; right: number; bottom: number; };
    renderCircle!: (() => void);
    renderText!: (() => void);
    renderTitle!: (() => void);
    addMouseOn!: (() => void);
    ...
    margins(m: { top: number; left: number; right: number; bottom: number; }){
