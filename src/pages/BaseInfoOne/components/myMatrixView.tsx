...
class MyMatrixView extends Component <MyMatrixViewProps, MyMatrixViewState>{
    ...
    xAxis = (g:any, x:any) => {
      ...
      g.attr("transform", `translate(0,${padding.top})`)
          ...
          .call((g:any) => {
              g.selectAll("text").attr("dy", 0).attr("font-size", "15px")
    ...
    yAxis = (g:any, y:any) => {
      ...
      g.attr("transform", `translate(${padding.left},0)`)
          ...
          .call((g:any) => g.selectAll("text").attr("font-size", "20px"))
    ...
    renderMatrixViewBackgound(){
      const {padding} = this.state
      padding.height = (document.getElementById("MyMatrixView") as HTMLElement).clientHeight*1.4
      padding.width = (document.getElementById("MyMatrixView") as HTMLElement).offsetWidth
