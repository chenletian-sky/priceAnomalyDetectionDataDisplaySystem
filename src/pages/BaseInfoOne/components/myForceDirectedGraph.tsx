...
class MyForceDirectedGraph extends Component<MyForceDirectedGraphProps, MyForceDirectedGraphState>{
  ...
  renderForceDirectedGraph() {
    const {  margin } = this.state.canvas
    const width = (document.getElementById("MyForceDirectedGraph") as HTMLElement).clientWidth
    const height = (document.getElementById("MyForceDirectedGraph") as HTMLElement).clientHeight
    ...
    const canvas = d3.select("#MyForceDirectedGraph")
      .append("div")
      .attr("height",(document.getElementById("MyForceDirectedGraph") as HTMLElement).offsetHeight)
      .attr("width",(document.getElementById("MyForceDirectedGraph") as HTMLElement).offsetWidth)
      .attr("class", 'forceGraph-canvas')
      .attr("style", "zoom:1")

    const parentHeight =  (document.getElementById("MyForceDirectedGraph") as HTMLElement).offsetHeight
    const parentWidth = (document.getElementById("MyForceDirectedGraph") as HTMLElement).offsetWidth

    const svg =
      // d3.select("#MyForceDirectedGraph")
      canvas.append("svg")
      // .attr("transform", `translate(${parentHeight},${parentWidth})`)
        // .attr("width", width + margin.left + margin.right)
        // .attr("height", height + margin.top + margin.bottom)
        .attr("height",parentHeight)
        .attr("width",parentWidth-100)
        // .attr("zoom",)
        .append("g")
